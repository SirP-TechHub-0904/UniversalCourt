...
namespace UniversalCourt.Application.Services.AWS
{
    public class StorageService : IStorageService
    {
        ...
        public async Task<FileReturnResponseDto> UploadFileReturnUrlAsync(UniversalCourt.Application.Dtos.AwsDtos.S3Object obj, AwsCredentials awsCredentialsValues, string old_key)
        {
            var credentials = new BasicAWSCredentials(awsCredentialsValues.AccessKey, awsCredentialsValues.SecretKey);
