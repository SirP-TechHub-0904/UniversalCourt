...
namespace UniversalCourt.Web.Areas.Staff.Pages.Dashboard
{
    ...
    public class DetailsModel : PageModel
    {
        ...
        public DetailsModel(UniversalCourt.Persistence.EF.SQL.DashboardDbContext context, IConfiguration config, IStorageService storageService, UserManager<Profile> userManager)
        {
            _context = context;
            _config = config;
