...
namespace UniversalCourt.Website.Areas.Admin.Pages.UserManagement
{
    ...
    public class BarCodeGeneratorModel : PageModel
    {
        ...
        public BarCodeGeneratorModel(SignInManager<Profile> signInManager,
            ...
            UserManager<Profile> userManager, UniversalCourt.Persistence.EF.SQL.DashboardDbContext context)
        {
