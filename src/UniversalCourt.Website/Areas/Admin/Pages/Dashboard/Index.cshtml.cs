...
using UniversalCourt.Application.Dtos.Dashboarrd;
using UniversalCourt.Application.Services;
using UniversalCourt.Domain.Models;
using UniversalCourt.Website.Areas.Admin.Pages.UserManagement;
...
namespace UniversalCourt.Website.Areas.Admin.Pages.Dashboard
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(UniversalCourt.Persistence.EF.SQL.DashboardDbContext context, UserManager<Profile> userManager)
        {
            _context = context;
