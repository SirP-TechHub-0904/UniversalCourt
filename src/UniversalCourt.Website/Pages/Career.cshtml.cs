...
namespace UniversalCourt.Website.Pages
{
    public class CareerModel : PageModel
    {
        ...
        public CareerModel(UniversalCourt.Persistence.EF.SQL.DashboardDbContext context, ISettingsService settingsService, IConfiguration config, IStorageService storageService)
        {
            _context = context;
            _config = config;
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            ViewData["CareerPath"] = new SelectList(_context.CareerPaths, "Id", "Title");
