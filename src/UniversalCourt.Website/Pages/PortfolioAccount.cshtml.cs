...
namespace UniversalCourt.Website.Pages
{
    public class PortfolioAccountModel : PageModel
    {
        ...
        public PortfolioAccountModel(UniversalCourt.Persistence.EF.SQL.DashboardDbContext context, ISettingsService settingsService, UserManager<Profile> userManager)
        {
            _context = context;
